...
- [x] 08-02-PLAN.md — Full inline-edit item table: add-row, per-field auto-save, delete with confirmation (ITEM-01, ITEM-02, ITEM-03)
...
| 8. Trip-Detail Inline-Edit Table (UI) | v2.0 | 2/2 | In Progress|  |
