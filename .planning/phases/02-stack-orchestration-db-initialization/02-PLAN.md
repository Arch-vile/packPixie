...
| D-06: Vite webServer — health http://localhost:5173, VITE\_\* env vars | COVERED | Plan 4, Task 4.1                             |
...
- [ ] apps/e2e/tsconfig.json include covers global-setup.ts, global-teardown.ts, src/\*_/_
